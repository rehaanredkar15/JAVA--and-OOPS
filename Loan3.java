...
class nintythree
{
	public static void main(String [] args)
	{
		homeloan h1;
		h1=new homeloan();
		h1.setdata(7456,3562,"devkar panand",45216,759864,"Rehan","kolhapur","home","single owner","Rehan",465,632,40,"devkar panand",7500000,4000000,0.20,24);  
		h1.showdata();
		h1.downpayment();
		h1.emi();
		...
		goldloan g1;
		g1=new goldloan();
		g1.setdata(7456,3562,"devkar panand",45216,759864,"Rehan","kolhapur",62,"earing",22,"Nirav modi","india",4000000,3000000,20,0.20);  
		g1.showdata();
		g1.settlement();
		...
		carloan c1;
		c1= new carloan();
		c1.setdata(7456,3562,"devkar panand",45216,759864,"Rehan","kolhapur","Fortuner","X250","White","petrol",1352,5000,2,100000,10000,6000000,30,0.10,5000000);
		c1.showdata();
		c1.onroadprice();
		c1.emi();
		...
		education e1;
		e1=new education();
		e1.setdata(7456,3562,"devkar panand",45216,759864,"Rehan","kolhapur","Engineering","Btech","DYPSN","Shivaji University",4,60000,"rehan",10,0.10,"rehan redkar",60000);
        e1.showdata();
		e1.emi();
		...
		a1.setdata(7456,3562,"devkar panand",45216,759864,"Rehan","kolhapur",603,"kol",6,"supic","nice",13000,.10,9);
		a1.showdata();
		a1.settlementamt();
		...
		personalloan p1;
		p1=new personalloan();
		p1.setdata(7456,3562,"devkar panand",45216,759864,"Rehan","kolhapur","infosys","web developement","pune",135264,"tester",5,63256,657,"Devkar Panand",13000,50000,.10,9);
		p1.showdata();
		p1.emi();
		p1.inhandamt();
		...
		businessloan b1;
		b1=new businessloan();
		b1.setdata(7456,3562,"devkar panand",45216,759864,"Rehan","kolhapur","infosys","web developement","single",88,"Rehan","Kolhapur","dev",3000000,70000,0.10,9,635624);
		b1.showdata();
		b1.totalaccect();
		b1.emi();
